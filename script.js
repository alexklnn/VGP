...
function showEventNotification(key) {
  ...
  // subtle alert sound
  const ping = new Audio("notification.mp3");
  ping.volume = 0.45;
  ping.play().catch(() => {});
...
type:
  ...
  "UNKNOWN",
    ...
    audio:
      item.status === "critical" ? "scream.mp3" :
      item.status === "amber" ? "car.mp3" :
      "door_slam.mp3",
...
const cameras = {
  camIcon01: { name: "CAM 01 - Main Gate", video: "MainEntrance.mp4", position: "50% 50%" },
  camIcon02: { name: "CAM 02 - North Perimeter", video: "construction.mp4", position: "50% 50%" },
  camIcon03: { name: "CAM 03 - Central", video: "busy street.mp4", position: "50% 50%" },
  camIcon04: { name: "CAM 04 - West Entrance", video: "parking lot2.mp4", position: "50% 50%" },
  camIcon05: { name: "CAM 05 - Parking Lot", video: "parking lot.mp4", position: "50% 50%" },
  camIcon06: { name: "CAM 06 - South Area", video: "cam06.mp4", position: "50% 50%" }
};
